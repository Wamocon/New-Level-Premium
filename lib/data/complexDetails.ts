...
export const complexDetails: Record<string, ComplexDetailData> = {
  "new-level-city": {
    ...
    "description": {
      "en": "An ideal place for comfortable living by the sea. This is a perfect offer for those who value the city rhythm and the comfort of living in the centre. The unique location ensures steady growth in property value and high rental potential. The city centre also qualifies for a residence permit, making the purchase even more attractive for investors and families planning to live in Turkey permanently.\n\nAbout the project\nThis modern five-storey city-style residential complex is already built and ready for occupancy. The residence has just 17 apartments with well-planned layouts and quality finishing. The ground floor is dedicated to commercial units, while the remaining four residential floors plus an attic level offer cosy apartments for comfortable living right in the heart of the action. Minimal infrastructure and the intimate format of the complex create an atmosphere of comfort and convenience for residents who value city amenities right at hand.\n\nAll apartments are delivered with high-quality turnkey finishing.\n\nPayment terms:\n✅ Installments up to 36 months with a down payment from 20%\n✅ Occupancy possible after the first payment\n✅ TAPU processing at 50% payment of the apartment value\n✅ Individual payment terms by arrangement with the developer\n\nSpecial advantages:\n✅ Direct sales from the developer, no intermediaries or overpayments\n✅ Flexible, favourable payment terms make the purchase as accessible as possible",
      "ru": "Идеальное место для комфортной жизни у моря. Это идеальное предложение для тех, кто ценит городской ритм и комфорт жизни в центре. Уникальная локация обеспечивает стабильный рост стоимости недвижимости и высокий арендный потенциал. Центр города также открыт для оформления ВНЖ, что делает покупку ещё более привлекательной для инвесторов и семей, планирующих жить в Турции постоянно.\n\nО проекте\nСовременный пятиэтажный жилой комплекс городского типа уже построен и готов к заселению. Всего в резиденции 17 апартаментов с продуманными планировками и качественной отделкой. Первый этаж отведён под коммерческую недвижимость, а остальные четыре жилые плюс мансардный этаж предлагают уютные квартиры для комфортной жизни в самом центре событий. Минимальная инфраструктура и камерный формат комплекса создают атмосферу уюта и удобства для жителей, которым важен доступ к городской инфраструктуре буквально «под рукой».\n\nВсе квартиры передаются с качественной чистовой отделкой «под ключ».\n\nУсловия оплаты:\n✅ Рассрочка до 36 месяцев при первоначальном взносе от 20%\n✅ Возможность заселения уже после первого платежа\n✅ Оформление ТАПУ при оплате 50% стоимости квартиры\n✅ Индивидуальные условия оплаты по договорённости с застройщиком\n\nСпециальные преимущества:\n✅ Прямые продажи от застройщика, без посредников и переплат\n✅ Гибкие и выгодные условия оплаты делают покупку максимально доступной",
      "tr": "Deniz kenarında konforlu yaşam için ideal bir yer. Şehrin ritmini ve merkezde yaşamanın konforunu önemseyenler için mükemmel bir teklif. Eşsiz konum, gayrimenkul değerinde istikrarlı artış ve yüksek kira potansiyeli sağlar. Şehir merkezi ayrıca oturma izni için de uygundur; bu da satın alımı, Türkiye'de kalıcı yaşamayı planlayan yatırımcılar ve aileler için daha da cazip kılar.\n\nProje hakkında\nModern beş katlı şehir tipi konut kompleksi hâlihazırda inşa edilmiş ve yerleşime hazırdır. Rezidansta toplam 17 daire; iyi planlanmış yerleşimler ve kaliteli işçilikle. Zemin kat ticari alana ayrılmış olup, kalan dört konut katı ile çatı katı, olayların tam merkezinde konforlu yaşam için şık daireler sunar. Minimal altyapı ve kompleksin butik formatı, şehir olanaklarına elinin altında erişmek isteyen sakinler için konfor ve rahatlık atmosferi yaratır.\n\nTüm daireler yüksek kaliteli anahtar teslim işçilikle teslim edilir.\n\nÖdeme koşulları:\n✅ %20'den başlayan peşinatla 36 aya kadar taksit\n✅ İlk ödemeden sonra yerleşim imkânı\n✅ Daire bedelinin %50'si ödendiğinde tapu işlemi\n✅ Geliştiriciyle mutabakatla bireysel ödeme koşulları\n\nÖzel avantajlar:\n✅ Geliştiriciden doğrudan satış, aracı veya ek ödeme yok\n✅ Esnek ve avantajlı ödeme koşulları satın alımı mümkün olduğunca erişilebilir kılar"
    },
    "benefits": {
      "en": [
  ...
  "new-level-cleopatra-2": {
    ...
    "description": {
      "en": "Welcome to an ultra-modern residential complex with hotel-grade infrastructure, an ideal choice for investment, holidays and a move by the sea.\n\nThis project is created for those seeking quality real estate in Turkey at a reasonable price. The complex is equally suited to permanent living, seasonal holidays and rental income. Most importantly, it qualifies for a Turkish residence permit and citizenship.\n\nAbout the project\nThe modern complex sits just 600 metres from the sea and beach, on a 3,030 m² plot. The grounds hold two 4-storey residential blocks with 58 apartments and fully landscaped surroundings. The project is considered down to the smallest detail, from the architectural concept to every element of the internal infrastructure. It is an excellent chance to buy premium real estate in Turkey with no overpayment, directly from the developer.\n\nAll apartments are delivered with high-quality turnkey finishing.\n\nConstruction stages:\nStart of construction: June 2024\nCompletion: December 2025\nThe complex is completed and the iskan has been received.\n\nPayment terms:\n✅ Installments up to 36 months\n✅ Down payment from 30%\n✅ No overpayments or hidden fees\n✅ 5% discount for full payment\n\nSpecial advantages:\n✅ Eligible for Turkish citizenship\n✅ High liquidity and steady price growth\n✅ A unique balance of price, quality and location",
      "ru": "Добро пожаловать в ультрасовременный жилой комплекс с отельной инфраструктурой, идеальный выбор для инвестиций, отдыха и переезда у моря!\n\nЭтот проект создан для тех, кто ищет качественную недвижимость в Турции по разумной цене. Комплекс одинаково хорошо подходит и для постоянного проживания, и для сезонного отдыха, и для получения дохода от аренды. А самое главное, он подходит для оформления ВНЖ и гражданства Турции.\n\nО проекте\nСовременный жилой комплекс расположен всего в 600 метрах от моря и пляжа, на участке площадью 3 030 м². На территории два 4-этажных жилых блока с 58 апартаментами и полностью благоустроенной территорией. Проект продуман до мелочей: от архитектурной концепции до каждой детали внутренней инфраструктуры. Это отличная возможность купить элитную недвижимость в Турции без переплат, напрямую от застройщика.\n\nВсе квартиры передаются с качественной чистовой отделкой «под ключ».\n\nЭтапы строительства:\nСтарт строительства: июнь 2024\nСдача в эксплуатацию: декабрь 2025\nКомплекс сдан в эксплуатацию, получен искан\n\nУсловия оплаты:\n✅ Рассрочка до 36 месяцев\n✅ Первоначальный взнос от 30%\n✅ Без переплат и скрытых комиссий\n✅ Скидка 5% при полной оплате\n\nСпециальные преимущества:\n✅ Проект подходит для получения турецкого гражданства\n✅ Высокая ликвидность и стабильный рост цен\n✅ Уникальное соотношение цены, качества и локации",
      "tr": "Otel seviyesinde altyapıya sahip ultra modern bir konut kompleksine hoş geldiniz; yatırım, tatil ve deniz kenarında yaşam için ideal bir seçim.\n\nBu proje, Türkiye'de makul fiyata kaliteli gayrimenkul arayanlar için tasarlandı. Kompleks; kalıcı yaşam, sezonluk tatil ve kira geliri için eşit derecede uygundur. En önemlisi, Türk oturma izni ve vatandaşlığı için uygundur.\n\nProje hakkında\nModern kompleks, denize ve plaja yalnızca 600 metre mesafede, 3.030 m²'lik bir arsa üzerinde yer alır. Alanda 58 daireli iki adet 4 katlı konut bloğu ve tamamen düzenlenmiş bir çevre bulunur. Proje, mimari konseptten iç altyapının her ayrıntısına kadar en ince detayına dek düşünülmüştür. Geliştiriciden doğrudan, ek ödeme yapmadan Türkiye'de premium gayrimenkul satın almak için mükemmel bir fırsattır.\n\nTüm daireler yüksek kaliteli anahtar teslim işçilikle teslim edilir.\n\nİnşaat aşamaları:\nİnşaat başlangıcı: Haziran 2024\nTamamlanma: Aralık 2025\nKompleks tamamlandı ve iskan alındı\n\nÖdeme koşulları:\n✅ 36 aya kadar taksit\n✅ %30'dan başlayan peşinat\n✅ Ek ödeme veya gizli ücret yok\n✅ Tam ödemede %5 indirim\n\nÖzel avantajlar:\n✅ Türk vatandaşlığına uygun\n✅ Yüksek likidite ve istikrarlı fiyat artışı\n✅ Eşsiz fiyat, kalite ve konum dengesi"
    },
    "benefits": {
      "en": [
        "Suitable for a residence permit and citizenship",
  ...
  "new-level-premium-share-of-apartments": {
    ...
    "description": {
      "en": "A smart investment by the sea: a format that combines a home, holidays and income.\n\nThis project brings together everything you have been looking for: full ownership, the chance to relax in your own apartment, short-term rental income, and 5-star hotel service. It is not just an apartment, it is an investment asset in the eco-friendly resort area of Avsallar, with developed infrastructure, sandy beaches and unique natural surroundings.\n\nIn our New Level Premium project, Block G offers a limited number of apartments where you can buy a share with the right to use it for a specific month. The apartment is fully furnished and equipped for a comfortable holiday, with a 1+1 layout.\n\nAbout the project\nThe project is located on a 52,000 m² plot in one of the most picturesque corners of Avsallar, just 900 metres from the Blue Flag awarded Incekum Beach. The territory will house a 5-star hotel with year-round operation, 7 residential blocks, and extensive social and entertainment infrastructure. An important feature: the area adjacent to the complex is a protected zone, which guarantees the absence of new construction and the preservation of panoramic views of the sea and nature.",
      "ru": "Умная инвестиция у моря: формат, объединяющий жильё, отдых и доход.\n\nПроект сочетает в себе всё, что вы искали: полноценное право собственности, возможность отдыха в собственных апартаментах, доход от краткосрочной аренды и сервис 5-звёздочного отеля. Это не просто квартира, это инвестиционный актив в экологичном курортном районе Авсаллар, с развитой инфраструктурой, песчаными пляжами и уникальной природой.\n\nВ нашем проекте New Level Premium в блоке G выделено всего несколько квартир, в которых вы можете приобрести долю с правом пользования в определённый месяц. Квартира полностью меблирована и оснащена всем необходимым для отдыха, планировка 1+1.\n\nО проекте\nПроект расположен на участке площадью 52 000 м² в одном из самых живописных уголков Авсаллара, всего в 900 метрах от пляжа Инжекум, отмеченного «Голубым флагом». На территории будут располагаться 5-звёздочный отель с круглогодичной работой, 7 жилых блоков и просторная социальная и развлекательная инфраструктура. Важная особенность: территория, прилегающая к комплексу, является заповедной зоной, что гарантирует отсутствие новых строек и сохранение панорамных видов на море и природу.",
      "tr": "Deniz kenarında akıllı bir yatırım: konut, dinlenme ve geliri bir araya getiren bir format.\n\nBu proje aradığınız her şeyi bir araya getiriyor: tam mülkiyet, kendi dairenizde dinlenme fırsatı, kısa süreli kira geliri ve 5 yıldızlı otel hizmeti. Bu sadece bir daire değil; gelişmiş altyapısı, kumlu plajları ve eşsiz doğasıyla Avsallar'ın çevre dostu tatil bölgesinde bir yatırım varlığı.\n\nNew Level Premium projemizin G Blokunda, belirli bir ay boyunca kullanım hakkıyla payınızı satın alabileceğiniz sınırlı sayıda daire bulunmaktadır. Daire tamamen mobilyalı ve konforlu bir tatil için gereken her şeyle donatılmıştır, 1+1 düzeninde.\n\nProje hakkında\nProje, Avsallar'ın en güzel köşelerinden birinde, Mavi Bayrak ödüllü İncekum Plajı'na sadece 900 metre mesafede, 52.000 m²'lik bir arsa üzerinde yer alır. Bölgede yıl boyu hizmet veren 5 yıldızlı bir otel, 7 konut bloğu ve kapsamlı sosyal ve eğlence altyapısı yer alacak. Önemli bir özellik: kompleksin bitişiğindeki alan koruma altındadır; bu da yeni yapılaşmanın önlenmesini ve denizin ve doğanın panoramik manzaralarının korunmasını garanti eder."
    },
    "benefits": {
      "en": [
