...
export const contentPages: Record<string, ContentPageData> = {
  "about": {
    ...
    "layout": "default",
    "images": [
      "/buildings/nl-23.webp",
      "/buildings/nl-20.webp",
      "/buildings/nl-19.webp"
    ],
    "title": {
    ...
    "intro": {
      "en": "NEW LEVEL GROUP is a Turkish developer building comfortable, high-quality and genuinely stylish homes along the Mediterranean coast.\n\nWe took everything we learned in real estate, tourism and hospitality and turned it into a construction company. For more than 10 years we have been building our own projects across the districts of Alanya. We do not just put up residential complexes; we shape living spaces of a new level of comfort. Every New Level Group project carries its own architectural idea, worked out with current design thinking and today's building technology.",
    ...
    "cards": {
      "en": [
        ...
        {
          "title": "Related areas",
          "text": "We are also growing in furniture production, agriculture and restaurants, which lets us offer clients and partners a genuinely all-round partnership."
        },
        {
          "title": "A large selection of properties for any purpose",
          "text": "We offer a wide selection of real estate, from modern apartments to elite villas, including finished complexes and projects still under construction. Every apartment works well for short-term rental, with options for a residence permit and citizenship by investment. Our projects meet the latest legal requirements. We build with our own funds only and always finish on time, which is how we keep the trust of partners and investors."
        },
        {
          "title": "Optimal value for money",
          "text": "Because we secure land plots on exclusive terms, we can offer our clients a real range of properties at the most favorable prices. We will help you find the right option, one that brings together a good location, high build quality, full amenities and a fair price."
        },
        {
        ...
        },
        {
          ...
          "text": "We choose only first-class land plots on the Mediterranean coast of Türkiye, so the views from your own apartment are ones you will want to wake up to. Every complex we build comes with its own varied, modern infrastructure."
        },
        {
